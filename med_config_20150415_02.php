<?php
	...
	define('MSG_106_URL','https://messaging.surescripts.net/SuiteRxpharmacy106x/AuthenticatingXmlServer.aspx');
	...
	define('FORCE_QUERY_INBOX_METHOD_TO_RETURN_N_RECORDS',3); 	
	...
	define('SPEAKER_ERROR_EMAIL_TO', 'surescripts@suiterx.com,amols@meditab.com,devphp@meditab.com,vipulp@meditab.com,devangt@meditab.com, support@suiterx.com,abnerf@suiterx.com,avanis@suiterx.com,vipulp@suiterx.com,maans@suiterx.com,jericob@suiterx.com,support5@suiterx.com,williamp@suiterx.com,ralph.suiterx@gmail.com,chiky.suiterx@gmail.com,alfredr@suiterx.com,ricardo.suiterx@gmail.com,erniloruedas.suiterx@gmail.com,jayson.suiterx@gmail.com,ace.suiterx@gmail.com,jason.suiterx@gmail.com');
	
	
	
	define('LISTENER_ERROR_EMAIL_SUBJECT', 'SuiteRx Surescripts Server Alert - Listener');
	define('LISTENER_ERROR_EMAIL_FROM', 'SRxSSProduction.Meditab.com');
	define('LISTENER_ERROR_EMAIL_TO', 'devphp@meditab.com,dhavals@meditab.com');
	
	
	define('EPCS_WEB_SERVICE_URL','http://localhost:8080/EPCS.asmx?wsdl');
	
	
	define('EPCS_DOCUMENTS_PATH','c:\\EPCS_Archive\\');
	
	
	
	define('PENDING_MESSAGE_ALERT_EMAIL_TO', 'amols@meditab.com,devphp@meditab.com,surescripts@suiterx.com,vipulp@meditab.com,devangt@meditab.com,support@suiterx.com,abnerf@suiterx.com,vipulp@suiterx.com,maans@suiterx.com,jericob@suiterx.com,support5@suiterx.com,williamp@suiterx.com,ralph.suiterx@gmail.com,chiky.suiterx@gmail.com,alfredr@suiterx.com,ricardo.suiterx@gmail.com,erniloruedas.suiterx@gmail.com,jayson.suiterx@gmail.com,ace.suiterx@gmail.com,jason.suiterx@gmail.com');
