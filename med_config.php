<?php
	...
	define('PORTAL_ID','616');
	define('DATA_PROVIDER_ID','SRXD61');
	define('DIR_LOGIN_ID','suiterxpharmacydir44');
	define('DIR_PASSWORD','Medit@b@4');
	define('DIR_VERSION','61');
	define('DIR_REQUEST_TO','SSDR61');
	//define('DIR_URL','https://admin.surescripts.net/Directory4dot4/directoryxmlserver.aspx');
	define('DIR_URL','https://dir-staging.surescripts.net/directory/Directory6dot1/v6_1');
	...
	define('DIR_DOWNLOAD_URL','https://admin-staging.surescripts.net/Downloads/');
	...
	define('FORCE_QUERY_INBOX_METHOD_TO_RETURN_N_RECORDS',5); 	
	...
	define('SPEAKER_ERROR_EMAIL_TO', 'surescripts@suiterx.com,devphp@meditab.com,bhushanm@meditab.com,support@suiterx.com,abnerf@suiterx.com,maans@suiterx.com,williamp@suiterx.com,alfredr@suiterx.com');
	...
	define('LISTENER_ERROR_EMAIL_TO', 'devphp@meditab.com,dhavals@meditab.com,bhushanm@meditab.com');
	...
	define('PENDING_MESSAGE_ALERT_EMAIL_TO', 'devphp@meditab.com,surescripts@suiterx.com,support@suiterx.com,abnerf@suiterx.com,maans@suiterx.com,williamp@suiterx.com,alfredr@suiterx.com,bhushanm@meditab.com');
	...
	define('ENABLE_MARK_IN_BOX_MESSAGE_AS_READ_LOG', 1);
