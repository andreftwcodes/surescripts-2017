<?php /* Smarty version 2.6.9, created on 2019-11-12 18:50:47
         compiled from ./middle/med_out_message_transaction_addedit.htm */ ?>
<form name="frm_add_record" id="frm_add_record" method="post" action="index.php">
  <input type="hidden" name="file" id="file" value="med_out_message_transaction_action"/>
  ...
  <table border="0" cellpadding="0" cellspacing="0"  width="100%" class="tab-bor" align="center">
    ...
    <tr>
      <td colspan="2" width="100%" align="left"><table cellpadding="1" cellspacing="1" width="100%" border="0">
          <tr>
            <td width="18%" align="right" valign="top"><?php echo $this->_tpl_vars['LBL_from_id']; ?>
</td>
		  ...
		  <tr>
            <td align="right" valign="top"><?php echo $this->_tpl_vars['LBL_sent_time_date']; ?>
</td>
            <td align="left" valign="top" colspan="3">
			<table border="0" cellpadding="0" cellspacing="0" align="left">
			<tr>
				<td align="left"><?php echo $this->_tpl_vars['strsent_time_date']; ?>
</td>
				<td align="left"><?php echo $this->_tpl_vars['strsent_time_time']; ?>
</td>
				<td align="left"><?php echo $this->_tpl_vars['strsent_time_ampm']; ?>
</td>
			</tr>
			</table>
			</td>
		  ...
		  <tr>
		   ...
		   <tr>
            <td align="right" valign="top"><?php echo $this->_tpl_vars['LBL_message_from']; ?>
</td>
            <td align="left" valign="top" colspan="3"><?php echo $this->_tpl_vars['strmessage_from']; ?>
</td>
		  </tr>
		  <tr>
            <td align="right" valign="top"><?php echo $this->_tpl_vars['LBL_meditab_id']; ?>
</td>
            <td align="left" valign="top" colspan="3"><?php echo $this->_tpl_vars['strmeditab_id']; ?>
</td>
		  </tr>
		  
		  <tr>
            <td align="right" valign="top"><?php echo $this->_tpl_vars['LBL_meditab_tran_id']; ?>
</td>
            <td align="left" valign="top" colspan="3"><?php echo $this->_tpl_vars['strmeditab_tran_id']; ?>
</td>
		  </tr>
		  <tr>
            <td align="right" valign="top"><?php echo $this->_tpl_vars['LBL_message_id']; ?>
</td>
            <td align="left" valign="top" colspan="3"><?php echo $this->_tpl_vars['strmessage_id']; ?>
</td>
		  </tr>
		  <tr>
            <td align="right" valign="top"><?php echo $this->_tpl_vars['LBL_related_message_id']; ?>
</td>
            <td align="left" valign="top" colspan="3"><?php echo $this->_tpl_vars['strrelated_message_id']; ?>
</td>
		  </tr>
		  ...
		  <tr>
            ...
            <td align="left" valign="top" colspan="3"><?php echo $this->_tpl_vars['strapp_name']; ?>
</td>
		  </tr>
		  <tr>
            <td align="right" valign="top"><?php echo $this->_tpl_vars['LBL_app_version']; ?>
</td>
            <td align="left" valign="top" colspan="3"><?php echo $this->_tpl_vars['strapp_version']; ?>
</td>
		  </tr>
		  <tr>
		  ...
		  <tr>
            <td align="right" valign="top"><?php echo $this->_tpl_vars['LBL_post_attempt']; ?>
</td>
            <td align="left" valign="top" colspan="3"><?php echo $this->_tpl_vars['strpost_attempt']; ?>
</td>
		  </tr>
		  <tr>
		  	<td align="right"></td>
...
{
	var strMessageFrom 
	strMessageFrom = document.getElementById("Rslt_message_from").value
	
	if(strMessageFrom == "PHARMACY")
	{
		document.getElementById("Tatxt_app_name").value = "IPS";
		document.getElementById("Tatxt_vendor_name").value = "SuiteRx";
	}
	else if(strMessageFrom == "PRESCRIBER")
	{
		document.getElementById("Tatxt_app_name").value = "IMS";
		document.getElementById("Tatxt_vendor_name").value = "SuiteMed LLC";
	}
	else
	{
		document.getElementById("Tatxt_app_name").value = "";
		document.getElementById("Tatxt_vendor_name").value = "";
	}
