<?php /* Smarty version 2.6.9, created on 2019-11-12 18:46:23
         compiled from ./middle/med_in_message_transaction.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'replace', './middle/med_in_message_transaction.htm', 39, false),)), $this); ?>
<form name="frm_list_record" id="frm_list_record" method="post" action="index.php">
  <input type="hidden" name="file" id="file"  value="med_in_message_transaction">
                  ...
                  <td class="vsrch"><table border="0" cellpadding="0" cellspacing="0" width="100%">
					  ...
					  <tr>
                        <td align="right"><table border="0" cellpadding="1" cellspacing="1">
                            <tr>
								<td align="right" valign="middle"><font class="blue-text-bold-01"><?php echo $this->_tpl_vars['Sr_LBL_Send_Recieve']; ?>
</font></td>
								<td align="left" valign="middle"><?php echo $this->_tpl_vars['Sr_strSend_Recieve']; ?>
</td>	
								<td align="right" valign="middle"><font class="blue-text-bold-01"><?php echo $this->_tpl_vars['Sr_LBL_time_in_message_from']; ?>
</font></td>
								<td align="left" valign="middle"><?php echo ((is_array($_tmp=$this->_tpl_vars['Sr_strtime_in_message_from'])) ? $this->_run_mod_handler('replace', true, $_tmp, '(mm-dd-yyyy)', '') : smarty_modifier_replace($_tmp, '(mm-dd-yyyy)', '')); ?>
</td>
								<td align="right" valign="middle"><font class="blue-text-bold-01"><?php echo $this->_tpl_vars['Sr_LBL_time_in_message_to']; ?>
</font></td>
								<td align="left" valign="middle"><?php echo ((is_array($_tmp=$this->_tpl_vars['Sr_strtime_in_message_to'])) ? $this->_run_mod_handler('replace', true, $_tmp, '(mm-dd-yyyy)', '') : smarty_modifier_replace($_tmp, '(mm-dd-yyyy)', '')); ?>
</td>
 ...
 &nbsp;</td>								
    ...
    <tr>
      <td colspan="2"><table width="100%" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td align="right"  valign="top" colspan="2"><img src="images/schedule-update.gif"  alt="Update In Message Transaction"  title="Update In Message Transaction" align="top"/>&nbsp;Update In Message Transaction&nbsp;</td>
          </tr>
        </table></td>
    </tr>
  </table>
