<?php /* Smarty version 2.6.9, created on 2019-11-15 20:27:30
         compiled from ./middle/med_page_buttons_listings.htm */ ?>
<form name="frm_page_buttons_listings" id="frm_page_buttons_listings" method="post" action="index.php">
<input type="hidden" name="file" id="file"  value="med_page_buttons_listings">
...
">
<input type="hidden" name="hidin_module_id" id="hidin_module_id" value="0" />
...
" />
<input type="hidden" name="med_delete_url" id="med_delete_url" value="med_page_buttons_listings" />
...
<span></td>
	<td width="47%" align="right" height="24"><a href="index.php?file=med_page_listings&hid_page_type=L&hidin_module_id=0"> All Tables</a>&nbsp;| <a href="index.php?file=med_page_add&hidin_module_id=0&table_id=<?php echo $this->_tpl_vars['intTableId']; ?>
...
&hidin_module_id=0&strLeftId=<?php echo $this->_tpl_vars['strLeftId']; ?>
">View Fields</a>&nbsp;|
      <span class="gray-text">View Buttons</span>&nbsp;|
...
">View Search</a>	  </td>
	...
	<tr>
	  ...
	  <table cellpadding="1" cellspacing="1" border="0">
		...
		<td><input type='button' name=btn1 value='Copy' onClick="doAction(this,'list3','1011:C:0:med_page_buttons_listings',1,'Are you sure want to Copy?')" class='btn'  ></td>
		</tr>
		</table>
	</td>
	</tr>
