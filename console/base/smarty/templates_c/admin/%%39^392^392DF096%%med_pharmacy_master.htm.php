<?php /* Smarty version 2.6.9, created on 2019-11-12 18:51:30
         compiled from ./middle/med_pharmacy_master.htm */ ?>
  <form name="frm_pharmacy_master" id="frm_pharmacy_master" method="post" action="index.php">
  <input type="hidden" name="file" id="file"  value="med_pharmacy_master">
                  ...
                  <td class="vsrch"><table border="0" cellpadding="0" cellspacing="0" width="100%">
					  ...
					  <tr>
                        <td align="right"><table border="0" cellpadding="1" cellspacing="1">
                            <tr>
                             <td align="right" valign="middle"><font class="blue-text-bold-01"><?php echo $this->_tpl_vars['Sr_LBL_ncpdpid']; ?>
</font></td>
                              <td align="left" valign="middle"><?php echo $this->_tpl_vars['Sr_strncpdpid']; ?>
</td>
							  <td align="right" valign="middle"><font class="blue-text-bold-01"><?php echo $this->_tpl_vars['Sr_LBL_store_name']; ?>
</font></td>
                              <td align="left" valign="middle"><?php echo $this->_tpl_vars['Sr_strstore_name']; ?>
</td> 
                              <td align="right" valign="middle"><font class="blue-text-bold-01"><?php echo $this->_tpl_vars['Sr_LBL_store_number']; ?>
</font></td>
                              <td align="left" valign="middle"><?php echo $this->_tpl_vars['Sr_strstore_number']; ?>
</td>  
                              <td align="right" valign="middle"><font class="blue-text-bold-01"><?php echo $this->_tpl_vars['Sr_LBL_npi']; ?>
</font></td>
                              <td align="left" valign="middle"><?php echo $this->_tpl_vars['Sr_strnpi']; ?>
</td>                              
						    </tr>
                          </table></td>                      
					  </tr>		
					   ...
					   <tr>
                        <td align="right">
							...
							<tr>
							  <td align="right" valign="top"><font class="blue-text-bold-01"><?php echo $this->_tpl_vars['Sr_LBL_show_rows']; ?>
</font></td>
                              <td align="left"  valign="top"><?php echo $this->_tpl_vars['Sr_strshow_rows']; ?>
 row(s)&nbsp;</td> 
							  <td align="right" valign="top"><font class="blue-text-bold-01"><?php echo $this->_tpl_vars['Sr_LBL_meditab_id_given']; ?>
</font></td>
                              <td align="left" valign="top"><?php echo $this->_tpl_vars['Sr_strmeditab_id_given']; ?>
</td>
							  <td align="right" valign="top"><font class="blue-text-bold-01"><?php echo $this->_tpl_vars['Sr_LBL_meditabId']; ?>
</font></td>
                              <td align="left" valign="top"><?php echo $this->_tpl_vars['Sr_strmeditabId']; ?>
</td>
							  ...
							  <td align="right" valign="top"><font class="blue-text-bold-01"><?php echo $this->_tpl_vars['Sr_LBL_directory_specialty']; ?>
</font></td>
                              <td align="left" valign="top"><?php echo $this->_tpl_vars['Sr_strdirectory_specialty']; ?>
</td>                                  
    ...
    <tr>
      <td colspan="2"><table width="100%" border="0" cellpadding="0" cellspacing="0">
		  ...
		  <tr>
            <td align="right"  valign="top" colspan="2"><img src="images/schedule-update.gif"  alt="Edit Pharmacy"  title="Edit Pharmacy" align="top"/>-&nbsp;Update Pharmacy&nbsp;&nbsp;&nbsp;* - Recently added.&nbsp;</td>
          </tr>
