<?php /* Smarty version 2.6.9, created on 2019-11-15 20:27:33
         compiled from ./middle/med_page_search_listings.htm */ ?>
<form name="frm_page_fields_listings" id="frm_page_search_listings" method="post" action="index.php">
<input type="hidden" name="file" id="file"  value="med_page_search_listings">
...
" />
<input type="hidden" name="med_delete_url" id="med_delete_url" value="med_page_search_listings" />
...
&hidin_module_id=0&strLeftId=<?php echo $this->_tpl_vars['strLeftId']; ?>
">View Buttons</a>&nbsp;|
	  <span class="gray-text">View Search</span>	  </td>
	...
	<tr>
	  ...
	  <table cellpadding="1" cellspacing="1" border="0">
		...
		<td><input type='button' name=btn1 value='Copy' onClick="doAction(this,'list5','1021:C:0:med_page_search_listings',1,'Are you sure want to Copy?')" class='btn'  ></td>
		</tr>
		</table>
	</td>
	</tr>
